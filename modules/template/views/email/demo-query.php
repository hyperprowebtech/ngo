...
<head>
    ...
    <title>New Demo Checklist</title>
    <style type="text/css">
        /* reset */
        article,
        aside,
                                                            ...
                                                            <tr>
                                                                <td align="center" valign="top" class="textContent">
                                                                    ...
                                                                    <h2
                                                                        ...
                                                                        Computer Premium Dashboard</h2>
                                                                    <!-- <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;"> has been completed. </div> -->
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" valign="middle"
                                                                                ...
                                                                                <a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;"
                                                                                    href="{base_url}site/list-demo"
                                                                                    target="_blank">View List</a>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
