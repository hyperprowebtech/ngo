            ...
            <div class="col-md-12">
                <div class="text-center animation animated fadeInUp"  data-aos="fade-up" data-animation="fadeInUp"
                    ...
                    <div class="heading_s1 text-center">
                        <h2 class="main-heading center-heading"><i class="fa fa-id-card"></i> Get Admit Card</h2>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <div class="btn-wrapper btn-wrapper2">
                                <?= $this->ki_theme->set_class('btn btn-outline-success')->button('<span><i class="fa fa-download"></i> Download</span>','submit') ?>
                            </div>
                        </div>
                    </div>
                </form>
